...
public class AddIncomeTypeActivity extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.check:
			Intent intent = new Intent(this, MakeOneIncomeActivity.class);
			intent.putExtra("newType", et.getText().toString());
			startActivity(intent);
			break;

		case R.id.go_back:
			startActivity(new Intent(this, MakeOneIncomeActivity.class));
			break;
		}
